                ...
                companyDetails ? (
                  <div className="space-y-4">
                    ...
                    <div className="grid sm:grid-cols-3 gap-4">
                      <Label>GSTIN</Label>
                      <p className="sm:col-span-2 text-sm text-muted-foreground">
                        {companyDetails.gstin || userData.gstin}
                      </p>
                    </div>
              ...
              <CardContent className="space-y-6">
                ...
                >
                  <div>
                    ...
                    <Label
                      htmlFor="light"
                      className="flex flex-col items-center justify-between rounded-md border-2 border-muted bg-popover p-4 peer-data-[state=checked]:border-primary"
                    >
